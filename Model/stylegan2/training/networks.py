...
class SynthesisBlock(torch.nn.Module):
    def __init__(self,
        ...
        fused_modconv_default   = False,         # Default value of fused_modconv. False for training, 'inference_only' = True for inference.
...
class Discriminator(torch.nn.Module):
    def __init__(self,
        ...
        # ==========================
        # self.line = nn.Sequential(nn.Linear(512, 64), nn.BatchNorm1d(64), nn.LeakyReLU(), nn.Linear(64, 1), nn.BatchNorm1d(1), nn.LeakyReLU())
...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, c=3, ndf=64, norm_layer=nn.BatchNorm2d):
